...
insert into dbo.OOZIE_SYS (name, data) values ('db.version', '3')
insert into dbo.OOZIE_SYS (name, data) values ('oozie.version', '4.2.0.2.5.0.0-1245')
