...
CREATE INDEX I_WF_CTNS_LAST_CHECK_TIME ON oozie.WF_ACTIONS (last_check_time);
CREATE INDEX I_WF_CTNS_PENDING ON oozie.WF_ACTIONS (pending);
...
CREATE INDEX I_WF_JOBS_CREATED_TIME ON oozie.WF_JOBS (created_time);
