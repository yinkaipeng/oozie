...
public class HeartbeatInsertJPAExecutor implements JPAExecutor<String> {
    private OozieSysBean sysBean = null;

    public HeartbeatInsertJPAExecutor(OozieSysBean sysBean) {
    ...
    public String getName() {
        return "HeartbeatInsertJPAExecutor";
    }
